    ...
    if not pd.api.types.is_datetime64_any_dtype(df.index):
        if 'Date' in df.columns:
             ...
             try:
                 ...
                 print("Warning: Could not convert 'YEAR' to datetime index.")
                 pass
        else:
            print("Warning: DataFrame index is not datetime and no 'Date' or 'YEAR' column found for conversion.")

    axs[0, 0].plot(df.index, df[sunactivity_col], color='blue', label='Sunspot Count')
